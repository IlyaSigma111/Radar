    ...
    <main className={`wall ${fullscreen ? 'fullscreen' : ''}`} ref={containerRef}>
      ...
      <header className="header">
        ...
        <div className="header-actions">
          <a href="/test" className="icon-btn" title="ТЕСТ-версия" style={{ textDecoration: 'none', color: '#f59e0b', fontSize: 10, fontWeight: 900, letterSpacing: 1, padding: '0 8px', border: '1px solid rgba(245,158,11,0.3)', borderRadius: 6, display: 'flex', alignItems: 'center', fontFamily: 'system-ui' }}>BETA</a>
